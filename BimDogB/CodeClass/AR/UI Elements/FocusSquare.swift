...
class FocusSquare: SCNNode {
    ...
    static let primaryColor = #colorLiteral(red: 0.5494993329, green: 0.7310366035, blue: 0.09920278937, alpha: 1) // base yellow
    static let primaryColorLight = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) // light yellow
    ...
    func hidden() {
        if self.opacity == 0.0 {
            self.renderOnTop(true)
            self.runAction(.fadeIn(duration: 0.0))
        }
    }
